...
switch ($price_wow) {
  ...
  $info_wow = '<h1>Локальные квесты</h1><br><br>
  ...
  $info_wow = '<h1>Избранный</h1><br><br>
    <h3>Услуга включает:</h3>
    <ul class="ulinfosite">
  ...
  $info_wow = '<h1>Баланс сил</h1><br><br>
    <h3>Услуга включает:</h3>
    <ul class="ulinfosite">
  ...
  $info_wow = '<h1>Услуга Кампания оплота</h1><br><br>
    <h3>Услуга включает:</h3>
    <ul class="ulinfosite">
      <li>Срок выполнения - 7-14 дней.</li>
    ...
    <br>
    <h3>Услуга Кампания оплота 7.2  включает:</h3>
    <ul class="ulinfosite">
  ...
  $info_wow = '<h1>Полеты в Легионе</h1><br><br>
    <h3>Услуга включает:</h3>
    <ul class="ulinfosite">
      <li>Срок выполнения - 7-14 дней.</li>
      <li>Требования: 110 уровень персонажа.</li>
  ...
  $info_wow = '<h1>Полеты в Легионе</h1><br><br>
    ...
    <br>
    <h3>Услуга включает прохождение сценария.</h3><br><br>
    <h3>Награды, которые вы получите за прохождение сценария:</h3>
    <ul class="ulinfosite">
  ...
  $info_wow = '<h1>Полеты в Легионе</h1><br><br>
    ...
    <br>
    <h3>Услуга включает прохождение всех цепочек заданий для получения достижения <b>Добрый сурамаритянин.</b></h3>
    <br><br>
    <h3>Свяжитесь с нашим оператором в правом нижнем углу для уточнения всех деталей или специальных условий.</h3>
    <div class="fancy"><h3>Скриншоты и видео</h3>
      <img width="120" height="90" src="img/wow.png" class="image-new" alt=""/>
  ...
  <div id='wrapper_tovar'>
    ...
    <br>
    <h3>Опция Следопыт Расколотых островов, часть 1 включает в себя:</h3>
    <ul class="ulinfosite">
    ...
    <h3>Опция Первопроходец Расколотых островов – часть 2 включает в себя:</h3>
    <ul class="ulinfosite">
  ...
  $info_wow = '<h1>Второстепенные профессии</h1><br><br>
    <h3>Услуга включает:</h3>
    <ul class="ulinfosite">
      <li>Срок выполнения: договорной.</li>
      <li>Требования: 110 уровень персонажа.</li>
    ...
    <h3 class="ulinfosite">Анигилят</h3>
  ...
  $info_wow = '<h1>Крафтовые профессии</h1><br><br>
    <h3>Услуга включает:</h3>
    <ul class="ulinfosite">
      <li>Срок выполнения: договорной.</li>
      <li>Требования: 110 уровень персонажа.</li>
  ...
  $info_wow = '<h1>Собирательные профессии</h1><br><br>
    <h3>Услуга включает:</h3>
    <ul class="ulinfosite">
      <li>Срок выполнения: договорной.</li>
      <li>Требования: 110 уровень персонажа.</li>
  ...
  $info_wow = '<h1>Выполнение квест лайна любой профессии до рейдового контента</h1><br><br>
    <h3>Услуга включает:</h3>
    <ul class="ulinfosite">
      <li>Срок выполнения: договорной.</li>
      <li>Требования: 110 уровень персонажа.</li>
    ...
    <h3>Нововведением в легионе для профессий стало:</h3>
    <ul class="ulinfosite">
  ...
  $info_wow = '<h1>Пакеты экипировки</h1><br><br>
    <h3>Услуга включает:</h3>
    <ul class="ulinfosite">
      <li>Срок выполнения: договорной.</li>
    </ul>
    <br>
    <h3>Быстрый и без лишних заморочек способ приодеть персонажа, предлагаем различные варианты:</h3>
    <ul class="ulinfosite">
  ...
  <div id='wrapper_tovar'>
    ...
    $info_wow = '<h1>Прокачка Рейтинга Поля Боя</h1><br><br>
    <h3>Услуга включает:</h3>
    <br>
    <h3>Доступные опции к заказу через сайт:</h3>
    <ul class="ulinfosite">
  ...
  $info_wow = '<h1>Победа на РБГ</h1><br><br>
    <h3>Услуга включает:</h3>
    <ul class="ulinfosite">
    ...
    <br><br>
    <h3>Седла ярости, которые позволит получить Вам следующих маунтов:</h3>
    <ul class="ulinfosite">
  ...
  $info_wow = '<h1>Анторус Фулл Гир все сложности</h1><br><br>
    <h3>Услуга включает:</h3>
    <ul class="ulinfosite">
      <li>Срок выполнения: договорной.</li>
...
$info_wow = '<h1>Фарм силы артефакта Обновлено под 7.3</h1><br><br>
    <h3>Услуга включает:</h3>
    <ul class="ulinfosite">
    ...
    <h3>Что такое Сила Артефакта?</h3>
    <ul class="ulinfosite">
  ...
  $info_wow = '<h1>Испытание Артефакта - Башня Магов</h1><br><br>
    <h3>Услуга включает:</h3>
  ...
  $info_wow = '<h1>Прокачка персонажа</h1><br><br>
    <h3>Услуга включает:</h3>
    <ul class="ulinfosite_price">
      <li>Срок прокачки:  1-2 дня..</li>
      <li>Требования к аккаунту: минимум 100 уровень.</li>
    </ul><br>
    <h3><b>Прокачка персонажа осуществляется исключительно руками, никаких ботов и автоматизированных программ!.</b></h3><br>
  ...
  $info_wow = '<h1>Уровень Престижа PvP</h1><br><br>
    <h3>Услуга включает:</h3>
    <br>
    ...
    <h3>Что такое уровни Престижа?:</h3>
    <ul class="ulinfosite">
  ...
  <div id='wrapper_tovar'>
    ...
    $info_wow = '<h1>Эпохальные ПЛЮС подземелья</h1><br><br>
    <h3>Услуга включает:</h3>
    <ul class="ulinfosite_price">
    ...
    <h3><b>Это очень быстрый и эффективный способ приодеться. Весь лут 940+ уровня и другой,  выпавший в процессе прохождения, на персонажа останутся в сумке.</b></h3><br>
    <h3>Описание услуги:</h3>
    <ul class="ulinfosite_price">
    ...
    <br><br>
    <h3>Эпохальные ключи имеют всего 2 характеристики:</h3>
    <ul class="ulinfosite_price">
      <li>Уровень;</li>
  ...
  $info_wow = '<h1">Эпохальные Подземелья</h1><br><br>
    <h3>Услуга включает:</h3>
    <ul class="ulinfosite_price">
      <li>Срок выполнения: от 2 часов</li>
      <li>Требование к персонажу: 110 уровень.</li>
    ...
    <h3>Ваш персонаж в составе нашей группы пройдет следующие подземелья:</h3>
    <ul class="ulinfosite_price">
    ...
    <h3>Доступно две услуги Прохождения Эпохальный Подземелий:</h3>
    <ul class="ulinfosite_price">
  ...
  $info_wow = '<h1>Эпохальные+ Подземелья Score</h1><br><br>
    <h3>Услуга включает:</h3>
    <ul class="ulinfosite_price">
    ...
    <h3>ВНИМАНИЕ! Перед тем, как оплачивать услугу, узнайте у оператора подходит ли ваш персонаж для выбраной опции Score.</h3>
    <div class="fancy"><h3>Скриншоты и видео</h3>
      <img width="120" height="90" src="img/wow.png" class="image-new" alt=""/>
      <img width="120" height="90" src="img/wot.png" class="image-new" alt=""/>
      <img width="120" height="90" src="img/cs.png" class="image-new" alt=""/>
  ...
  $info_wow = '<h1>Поводья черного боевого маханодолгонога</h1><br><br>
    <h3>Услуга включает:</h3>
    <ul class="ulinfosite_price">
  ...
  $info_wow = '<h1>Поводья яростного боевого коня-скелета</h1><br><br>
    <h3>Услуга включает:</h3>
    <ul class="ulinfosite_price">
      <li>Срок выполнения: 4 - 8 часов.</li>
    </ul><br><br><br>
  ...
  $info_wow = '<h1>Поводья пеплошкурого дикого мушана</h1><br><br>
    <h3>Услуга включает:</h3>
    <ul class="ulinfosite_price">
      <li>Срок выполнения: 4 - 8 часов.</li>
    </ul><br><br><br>
  ...
  $info_wow = '<h1>Поводья вороного боевого скакуна</h1><br><br>
    <h3>Услуга включает:</h3>
    <ul class="ulinfosite_price">
      <li>Срок выполнения: 4 - 8 часов.</li>
    </ul><br><br><br>
  ...
  $info_wow = '<h1>Поводья яростного боевого лиса</h1><br><br>
    <h3>Услуга включает:</h3>
    <ul class="ulinfosite_price">
      <li>Срок выполнения: 4 - 8 часов.</li>
    </ul><br><br><br>
  ...
  $info_wow = '<h1>Поводья прославленного полуночного скакуна</h1><br><br>
    <h3>Услуга включает:</h3>
    <ul class="ulinfosite_price">
      <li>Срок выполнения: 4 - 8 часов.</li>
    </ul><br><br><br>
  ...
  $info_wow = '<h1>Поводья прославленного бронзового скакуна</h1><br><br>
    <h3>Услуга включает:</h3>
    <ul class="ulinfosite_price">
      <li>Срок выполнения: 4 - 8 часов.</li>
    </ul><br><br><br>
  ...
  $info_wow = '<h1>Поводья яростного боевого волка</h1><br><br>
    <h3>Услуга включает:</h3>
    <ul class="ulinfosite_price">
      <li>Срок выполнения: 4 - 8 часов.</li>
    </ul><br><br><br>
  ...
  $info_wow = '<h1>Поводья прославленного лазурного скакуна</h1><br><br>
    <h3>Услуга включает:</h3>
    <ul class="ulinfosite_price">
      <li>Срок выполнения: 4 - 8 часов.</li>
    </ul><br><br><br>
  ...
  $info_wow = '<h1>Поводья прославленного белого скакуна</h1><br><br>
    <h3>Услуга включает:</h3>
    <ul class="ulinfosite_price">
      <li>Срок выполнения: 4 - 8 часов.</li>
    </ul><br><br><br>
  ...
  $info_wow = '<h1>Поводья прославленного королевского скакуна</h1><br><br>
    <h3>Услуга включает:</h3>
    <ul class="ulinfosite_price">
      <li>Срок выполнения: 4 - 8 часов.</li>
    </ul><br><br><br>
  ...
  $info_wow = '<h1>Поводья яростного боевоевого медведя</h1><br><br>
    <h3>Услуга включает:</h3>
    <ul class="ulinfosite_price">
      <li>Срок выполнения: 4 - 8 часов.</li>
    </ul><br><br><br>
  ...
  $info_wow = '<h1>Поводья яростной боевой черепахи</h1><br><br>
    <h3>Услуга включает:</h3>
    <ul class="ulinfosite_price">
      <li>Срок выполнения: 4 - 8 часов.</li>
    </ul><br><br><br>
  ...
  $info_wow = '<h1>Поводья палевого крылобега</h1><br><br>
    <h3>Услуга включает:</h3>
    <ul class="ulinfosite_price">
      <li>Срок выполнения: 4 - 8 часов.</li>
    </ul><br><br><br>
  ...
  $info_wow = '<h1>Поводья прославленного боевого волка</h1><br><br>
    <h3>Услуга включает:</h3>
    <ul class="ulinfosite_price">
      <li>Срок выполнения: 4 - 8 часов.</li>
    </ul><br><br><br>
  ...
  $info_wow = '<h1>Поводья яростного боевого саблезуба</h1><br><br>
    <h3>Услуга включает:</h3>
    <ul class="ulinfosite_price">
      <li>Срок выполнения: 4 - 8 часов.</li>
    </ul><br><br><br>
  ...
  $info_wow ='<h1>Поводья прославленного боевого коня</h1><br><br>
    <h3>Услуга включает:</h3>
    <ul class="ulinfosite_price">
      <li>Срок выполнения: 4 - 8 часов.</li>
    </ul><br><br><br>
  ...
  $info_wow = '<h1>Поводья яростного боевого гилнеасского коня</h1><br><br>
    <h3>Услуга включает:</h3>
    <ul class="ulinfosite_price">
      <li>Срок выполнения: 4 - 8 часов.</li>
    </ul><br><br><br>
  ...
  $info_wow = '<h1>Поводья яростного крылобега</h1><br><br>
    <h3>Услуга включает:</h3>
    <ul class="ulinfosite_price">
      <li>Срок выполнения: 4 - 8 часов.</li>
    </ul><br><br><br>
  ...
  $info_wow = '<h1>Поводья яростного боевого трицикла</h1><br><br>
    <h3>Услуга включает:</h3>
    <ul class="ulinfosite_price">
      <li>Срок выполнения: 4 - 8 часов.</li>
    </ul><br><br><br>
  ...
  $info_wow ='<h1>Поводья яростного боевого элика</h1><br><br>
    <h3>Услуга включает:</h3>
    <ul class="ulinfosite_price">
      <li>Срок выполнения: 4 - 8 часов.</li>
    </ul><br><br><br>
  ...
  $info_wow = '<h1>Поводья черного боевого барана</h1><br><br>
    <h3>Услуга включает:</h3>
    <ul class="ulinfosite_price">
      <li>Срок выполнения: 4 - 8 часов.</li>
    </ul><br><br><br>
  ...
  $info_wow = '<h1>Поводья яростного боевого механодолгонога</h1><br><br>
    <h3>Услуга включает:</h3>
    <ul class="ulinfosite_price">
      <li>Срок выполнения: 4 - 8 часов.</li>
    </ul><br><br><br>
  ...
  $info_wow = '<h1>Поводья яростного боевого кодо</h1><br><br>
    <h3>Услуга включает:</h3>
    <ul class="ulinfosite_price">
      <li>Срок выполнения: 4 - 8 часов.</li>
    </ul><br><br><br>
  ...
  $info_wow = '<h1>Поводья яростного боевого ящера</h1><br><br>
    <h3>Услуга включает:</h3>
    <ul class="ulinfosite_price">
      <li>Срок выполнения: 4 - 8 часов.</li>
    </ul><br><br><br>
  ...
  $info_wow ='<h1>Поводья яростного боевого барана</h1><br><br>
    <h3>Услуга включает:</h3>
    <ul class="ulinfosite_price">
      <li>Срок выполнения: 4 - 8 часов.</li>
    </ul><br><br><br>
  ...
  $info_wow ='<h1>Поводья черного боевого талбука</h1><br><br>
    <h3>Услуга включает:</h3>
    <ul class="ulinfosite_price">
      <li>Срок выполнения: 4 - 8 часов.</li>
    </ul><br><br><br>
  ...
  $info_wow ='<h1>Поводья боевого скакуна грозовой вершины</h1><br><br>
    <h3>Услуга включает:</h3>
    <ul class="ulinfosite_price">
      <li>Срок выполнения: 4 - 8 часов.</li>
    </ul><br><br><br>
  ...
  $info_wow = '<h1>Поводья черного боевого кодо</h1><br><br>
    <h3>Услуга включает:</h3>
    <ul class="ulinfosite_price">
      <li>Срок выполнения: 4 - 8 часов.</li>
    </ul><br><br><br>
  ...
  $info_wow ='<h1>Поводья яростного боевого коня</h1><br><br>
    <h3>Услуга включает:</h3>
    <ul class="ulinfosite_price">
      <li>Срок выполнения: 4 - 8 часов.</li>
    </ul><br><br><br>
  ...
  <div id='wrapper_tovar'>
    ...
    $info_wow ='<h1>Поводья стремительного боевого крылобега</h1><br><br>
    <h3>Услуга включает:</h3>
    <ul class="ulinfosite_price">
      <li>Срок выполнения: 4 - 8 часов.</li>
    </ul><br><br><br>
  ...
  $info_wow ='<h1>Поводья черного боевого ящера</h1><br><br>
    <h3>Услуга включает:</h3>
    <ul class="ulinfosite_price">
      <li>Срок выполнения: 4 - 8 часов.</li>
    </ul><br><br><br>
  ...
  $info_wow = '<h1>Поводья красного боевого коня</h1><br><br>
    <h3>Услуга включает:</h3>
    <ul class="ulinfosite_price">
      <li>Срок выполнения: 4 - 8 часов.</li>
    </ul><br><br><br>
  ...
  $info_wow ='<h1>Поводья черного боевого волка</h1><br><br>
    <h3>Услуга включает:</h3>
    <ul class="ulinfosite_price">
      <li>Срок выполнения: 4 - 8 часов.</li>
    </ul><br><br><br>
  ...
  $info_wow = '<h1>Поводья черного боевого мамонта</h1><br><br>
    <h3>Услуга включает:</h3>
    <ul class="ulinfosite_price">
      <li>Срок выполнения: 4 - 8 часов.</li>
    </ul><br><br><br>
  ...
  $info_wow = '<h1>Поводья черного боевого медведя</h1><br><br>
    <h3>Услуга включает:</h3>
    <ul class="ulinfosite_price">
      <li>Срок выполнения: 4 - 8 часов.</li>
    </ul><br><br><br>
  ...
  $info_wow ='<h1>Поводья черного боевого саблезуба</h1><br><br>
    <h3>Услуга включает:</h3>
    <ul class="ulinfosite_price">
      <li>Срок выполнения: 4 - 8 часов.</li>
    </ul><br><br><br>
  ...
  $info_wow ='<h1>Поводья черного боевого элекка</h1><br><br>
    <h3>Услуга включает:</h3>
    <ul class="ulinfosite_price">
      <li>Срок выполнения: 4 - 8 часов.</li>
    </ul><br><br><br>
  ...
  $info_wow ='<h1>Янтарный доисторический дикорог</h1><br><br>
    <h3>Услуга включает:</h3>
    <ul class="ulinfosite_price">
  ...
  $info_wow = '<h1>Солнечный ястреб пиков</h1><br><br>
    <h3>Услуга включает:</h3>
    <ul class="ulinfosite_price">
      <li>Срок выполнения: договорной</li>
  ...
  $info_wow = '<h1>Солнечношкурый малый гронн</h1><br><br>
    <h3>Услуга включает:</h3>
    <ul class="ulinfosite_price">
      <li>Срок выполнения: 1 - 7 дней.</li>
      <li>Требования к аккаунту:  Персонаж 100 уровня.</li>
    ...
    <h3>Для получения маунта есть 2 пути:</h3>
    <ul class="ulinfosite_price">
  ...
  $info_wow = '<h1>Сланцевый доисторический дикорог</h1><br><br>
    <h3>Услуга включает:</h3>
    <ul class="ulinfosite_price">
      <li>Срок выполнения: 1 - 7 дней.</li>
    </ul><br><br><br>
  ...
  $info_wow = '<h1>Сапфировое речное чудище</h1><br><br>
    <h3>Услуга включает:</h3>
    <ul class="ulinfosite_price">
      <li>Срок выполнения: 1 - 7 дней.</li>
      <li>Требования к аккаунту:  Персонаж 100 уровня.</li>
  ...
  $info_wow = '<h1>Самец-кровокопыт</h1><br><br>
    <h3>Услуга включает:</h3>
    <ul class="ulinfosite_price">
      <li>Срок выполнения: 1 - 7 дней.</li>
      <li>Требования к аккаунту:  Персонаж 100 уровня.</li>
  ...
  $info_wow ='<h1>Пятнистый лугопотам</h1><br><br>
    <h3>Услуга включает:</h3>
    <ul class="ulinfosite_price">
  ...
  $info_wow = '<h1>Поводья посейдуса</h1><br><br>
    <h3>Услуга включает:</h3>
    <ul class="ulinfosite_price">
      <li>Срок выполнения: 1 - 5 дней.</li>
    </ul><br><br><br>
  ...
  $info_wow = '<h1>Огромный сероклык</h1><br><br>
    <h3>Услуга включает:</h3>
    <ul class="ulinfosite_price">
      <li>Срок выполнения: 1 - 7 дней.</li>
      <li>Требования к аккаунту:  Персонаж 100 уровня.</li>
  ...
  $info_wow = '<h1>Нефритовый доисторический дикорог</h1><br><br>
    <h3>Услуга включает:</h3>
    <ul class="ulinfosite_price">
      <li>Срок выполнения: 1 - 7 дней.</li>
    </ul><br><br><br>
    <h3>Вы получите маунта</h3>
    <ul class="ulinfosite_price">
  ...
  $info_wow = '<h1>Поводья небесного ониксового облачного змея</h1><br><br>
    <h3>Услуга включает:</h3>
    <ul class="ulinfosite_price">
  ...
  $info_wow = '<h1>Поводья нефритового доисторического дикорога</h1><br><br>
    <h3>Услуга включает:</h3>
    <ul class="ulinfosite_price">
      <li>Срок выполнения: 1 - 7 дней.</li>
    </ul><br><br><br>
  ...
  $info_wow = '<h1>Кислотный изрыгатель</h1><br><br>
    <h3>Услуга включает:</h3>
    <ul class="ulinfosite_price">
      <li><Срок выполнения: 1-2 недели./li>
      <li>Требования к персонажу: 110 уровень.</li>
    </ul><br><br><br>
    <h3>Кислотный изрыгатель включает:</h3>
    <ul class="ulinfosite_price">
  ...
  $info_wow = '<h1>Грозовой кобальтовый облачный змей</h1><br><br>
    <h3>Услуга включает:</h3>
    <ul class="ulinfosite_price">
      <li>Срок выполнения: 1 - 50 дней.</li>
    </ul><br><br><br>
  ...
  $info_wow = '<h1>Быстрый ветробег</h1><br><br>
    <h3>Услуга включает:</h3>
    <ul class="ulinfosite_price">
      <li>Срок выполнения: 1-2 недели.</li>
  ...
  $info_wow = '<h1>Бронированный шипастый кабан</h1><br><br>
    <h3>Услуга включает:</h3>
    <ul class="ulinfosite_price">
      <li>Срок выполнения: 1-2 недели.</li>
      <li>Требования к персонажу: 110 уровень.</li>
  ...
  $info_wow = '<h1>Багровый рабоглот</h1><br><br>
    <h3>Услуга включает:</h3>
    <ul class="ulinfosite_price">
      <li>Срок выполнения: 1-2 недели.</li>
      <li>Требования к персонажу: 110 уровень.</li>
  ...
  <img style="border-radius: 10px 10px 0 0" src="gameimg/wow/price/goldprice.png" alt="">
    ...
    <br>
		...
		$info_wow = '<h1>Калькулятор золота World of Warcraft</h1><br><br>
		<h3>Услуга включает:</h3>
		<ul class="ulinfosite_price">
...
Предусмотрен  возврат средств, если Вы передумали, или в случаях не получения денег в полном объеме</p>';
  ...
  $info_wow = '<h1>Ульдир</h1><br><br>
		<h3>Услуга включает:</h3><br>
		<ul class="ulinfosite_price">
